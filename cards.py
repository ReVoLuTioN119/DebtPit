...
card1 = Card('kirril', 1, 1, '', controls.card_image, controls.cardd_show)
card2 = Card('kirill1', 1, 1, '', controls.card_image, controls.cardd_show)
card3 = Card('kirill2', 1, 1, '', controls.card_image, controls.cardd_show)
card4 = Card('kirill3', 1, 1, '', controls.card_image, controls.cardd_show)
card5 = Card('kirill4', 1, 1, '', controls.card_image, controls.cardd_show)
card6 = Card('kirill5', 1, 1, '', controls.card_image, controls.cardd_show)
card7 = Card('kirill6', 1, 1, '', controls.card_image, controls.cardd_show)
card8 = Card('kirill7', 1, 1, '', controls.card_image, controls.cardd_show)
card9 = Card('kirill8', 1, 1, '', controls.card_image, controls.cardd_show)
card10 = Card('kirill9', 1, 1, '', controls.card_image, controls.cardd_show)
card11 = Card('kirill0', 1, 1, '', controls.card_image, controls.cardd_show)
card12 = Card('kirill00', 1, 1, '', controls.card_image, controls.cardd_show)
card13 = Card('1', 1, 1, '', controls.card_image, controls.cardd_show)
card14 = Card('2', 1, 1, '', controls.card_image, controls.cardd_show)
card15 = Card('3', 1, 1, '', controls.card_image, controls.cardd_show)
