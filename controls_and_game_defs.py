...
height = 460  # resolution.current_h
...
deck_full = pygame.transform.scale(deck_full_raw, (deck_full_raw.get_width() / correction_image[0],
                                                   deck_full_raw.get_height() / correction_image[1]))
deck_full_point_raw = pygame.image.load('images/deck_point.png').convert()
deck_full_point = pygame.transform.scale(deck_full_point_raw, (deck_full_point_raw.get_width() / correction_image[0],
                                                               deck_full_point_raw.get_height() / correction_image[1]))
deck_empty_raw = pygame.image.load('images/empty_deck.png').convert()
deck_empty = pygame.transform.scale(deck_empty_raw, (deck_full_raw.get_width() / correction_image[0],
                                                     deck_full_raw.get_height() / correction_image[1]))
field_image_raw = pygame.image.load('images/field.png').convert()
field_image = pygame.transform.scale(field_image_raw, (field_image_raw.get_width() / correction_image[0],
                                                       field_image_raw.get_height() / correction_image[1]))
card_image_raw = pygame.image.load('images/cardsback.png').convert()
card_image = pygame.transform.scale(card_image_raw, (card_image_raw.get_width() / correction_image[0],
                                                     card_image_raw.get_height() / correction_image[1]))
card_show_raw = pygame.image.load('images/cardsback_show.png').convert()
cardd_show = pygame.transform.scale(card_show_raw, (card_show_raw.get_width() / correction_image[0],
                                                    card_show_raw.get_height() / correction_image[1]))
card_correct_raw = pygame.Surface((20, 20), pygame.SRCALPHA, 32).convert_alpha()
card_correct = pygame.transform.scale(card_correct_raw, (card_correct_raw.get_width() / correction_image[0],
                                                         card_correct_raw.get_height() / correction_image[1]))
turn_button_raw = pygame.image.load('images/turn_button.png').convert()
turn_button = pygame.transform.scale(turn_button_raw, (turn_button_raw.get_width() / correction_image[0],
...
turn_button_point = pygame.transform.scale(turn_button_point_raw,
...
arm_enemy_4 = pygame.transform.scale(arm_enemy_4_raw, ((arm_enemy_4_raw.get_width() / correction_image[0]),
                                                       (arm_enemy_4_raw.get_height() / correction_image[1])))
arm_enemy_3_raw = pygame.image.load('images/arm/arm_3.png').convert_alpha()
arm_enemy_3 = pygame.transform.scale(arm_enemy_3_raw, ((arm_enemy_3_raw.get_width() / correction_image[0]),
                                                       (arm_enemy_3_raw.get_height() / correction_image[1])))
arm_enemy_2_raw = pygame.image.load('images/arm/arm_2.png').convert_alpha()
arm_enemy_2 = pygame.transform.scale(arm_enemy_2_raw, ((arm_enemy_2_raw.get_width() / correction_image[0]),
                                                       (arm_enemy_2_raw.get_height() / correction_image[1])))
arm_enemy_1_raw = pygame.image.load('images/arm/arm_1.png').convert_alpha()
arm_enemy_1 = pygame.transform.scale(arm_enemy_1_raw, ((arm_enemy_1_raw.get_width() / correction_image[0]),
                                                       (arm_enemy_1_raw.get_height() / correction_image[1])))
arm_enemy_0_raw = pygame.image.load('images/arm/arm_0.png').convert_alpha()
arm_enemy_0 = pygame.transform.scale(arm_enemy_0_raw, ((arm_enemy_0_raw.get_width() / correction_image[0]),
...
def turn_button_def(screen):
    global turn_push, turn_player, output_text_before_taking, turn_button, card_action
    turn_button_rect = turn_button.get_rect(midright=(width - width / 100,
    ...
    if turn_push and turn_button_rect.collidepoint(pygame.mouse.get_pos()):
        ...
        card_action = False
    elif not turn_push and not turn_button_rect.collidepoint(pygame.mouse.get_pos()):
        output_text_before_taking = False
